...
export const metadata: Metadata = {
  title: "Anonime - Fine Dining Restaurant",
  description: "Experience exceptional cuisine and intimate dining at Anonime. Reserve your table for an unforgettable culinary journey.",
  keywords: "fine dining, restaurant, reservations, gourmet cuisine",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Anonime - Fine Dining Restaurant",
    description: "Experience exceptional cuisine and intimate dining at Anonime.",
    type: "website",
    siteName: "Anonime"
  }
};
